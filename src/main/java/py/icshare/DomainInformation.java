...
public class DomainInformation {
  ...
  public DomainInformation(Long domainId, String domainName, String domainDescription,
      String dataNodes,
      String storagePools) {
  ...
  public boolean equals(Object obj) {
    ...
    DomainInformation otherDomainInformation = (DomainInformation) obj;
    // domainId
  ...
  public Domain toDomain() {
    ...
    if (dataNodes != null) {
      ...
      datanodeList.addAll(Utils.parseObjecLongFromJsonStr(dataNodes));
    ...
    if (storagePools != null) {
      ...
      storagePoolSet.addAll(Utils.parseObjecLongFromJsonStr(storagePools));
      if (storagePools != null) {
